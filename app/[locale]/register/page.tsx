...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (form.password !== form.password_confirmation) {
      setErrors({ password_confirmation: t('passwordsDoNotMatch') });
      ...
      <div style={{ width: '100%', maxWidth: '440px', position: 'relative', zIndex: 1 }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: '40px' }}>
          ...
          <p style={{ color: 'var(--color-text-secondary)', fontSize: '14px', marginTop: '4px' }}>
            {locale === 'ar' ? 'منصة إدارة الفنادق' : 'Hotel Management Platform'}
          </p>
        </div>
          ...
          <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
            ...
            <div>
              ...
              <input
                ...
                required
                autoComplete="name"
                placeholder={isRtl ? 'جون سميث' : 'John Smith'}
                style={{ ...inputStyle('name'), textAlign: isRtl ? 'right' : 'left' }}
            ...
            <div>
              ...
              <input
                ...
                placeholder={isRtl ? 'الحد الأدنى 8 أحرف' : 'Min. 8 characters'}
            ...
            >
              {isSubmitting ? t('creatingAccount') : (isRtl ? 'أنشئ حساباً' : 'Create account')}
            </button>
          </form>
        </div>
